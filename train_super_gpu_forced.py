...
def main(cfg: DictConfig) -> None:
    ...
    if launcher == "stylegan":
        ...
        cmd = [
            ...
            f"+model.loss_kwargs.source=StyleGAN2Loss",  # ADD model.loss_kwargs.source (required parameter)
            f"+model.loss_kwargs.style_mixing_prob=0.0",  # ADD model.loss_kwargs.style_mixing_prob (required parameter)
